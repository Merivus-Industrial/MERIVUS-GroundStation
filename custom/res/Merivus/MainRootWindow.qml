...
ApplicationWindow {
    ...
    minimumWidth:   ScreenTools.isMobile ? Screen.width  : Math.min(1120, Screen.width)
    minimumHeight:  ScreenTools.isMobile ? Screen.height : Math.min(640, Screen.height)
    visible:        true
    ...
    function showSettingsTool() {
        showTool(qsTr("Application Settings"), "AppSettings.qml", "/qmlimages/mrws2.png")
    }
    ...
    header: MainToolBar {
        id:         toolbar
        height:     Math.max(ScreenTools.toolbarHeight, ScreenTools.defaultFontPixelHeight * 3.5)
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    SubMenuButton {
                        ...
                        imageResource:      "/qmlimages/mrws2.png"
