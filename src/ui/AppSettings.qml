...
Rectangle {
    ...
    property string _requestedSettingsPage: QGroundControl.loadGlobalSetting("Merivus/AppSettingsPage", "")
    ...
    Component.onCompleted: {
        ...
        } else if (_requestedSettingsPage.length > 0) {
            __rightPanel.source = _requestedSettingsPage
            QGroundControl.saveGlobalSetting("Merivus/AppSettingsPage", "")
        } else {
            ...
            Repeater {
                ...
                QGCButton {
                    ...
                    Component.onCompleted: {
                        ...
                        if(_first) {
                            _first = false
                            checked = modelData.url == __rightPanel.source
                        } else if (modelData.url == __rightPanel.source) {
                            checked = true
                        }
