    ...
    Component {
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        GridLayout {
                            ...
                            QGCLabel {
                                text:               qsTr("Low: Warn / Critical: Failsafe / Emergency: Emergency")
                                Layout.fillWidth:   true
                            }
                            ...
                            QGCLabel {
                                // TODO: Bind to battery estimate from vehicle telemetry or a QGC backend property.
                                text:               _pendingIntegrationText
                                Layout.fillWidth:   true
                            }

                            QGCLabel {
                                text:               qsTr("Estimated RTL Battery Required:")
                                Layout.fillWidth:   true
                            }
                            QGCLabel {
                                // TODO: Bind to return energy prediction from a QGC backend property.
                                text:               _pendingIntegrationText
                                Layout.fillWidth:   true
                            }
                        }
                ...
                Rectangle {
                    width:                  mainRow.width + (_margins * 2)
                    height:                 gnssVisualGrid.height + (_margins * 2)
                    color:                  qgcPal.windowShade
                    Row {
                        id:                 gnssVisualGrid
                        spacing:            _margins
                        ...
                        Item {
                            ...
                            QGCColoredImage {
                                color:              qgcPal.text
                                source:             "/qmlimages/MerivusSafetyGNSS.svg"
                                height:             _imageHeight
                                width:              _imageHeight
                                anchors.centerIn:   parent
                            }
                ...
                Rectangle {
                    width:                  mainRow.width + (_margins * 2)
                    height:                 iotTcpGrid.height + (_margins * 2)
                    color:                  qgcPal.windowShade
                    Row {
                        id:                 iotTcpGrid
                        spacing:            _margins
